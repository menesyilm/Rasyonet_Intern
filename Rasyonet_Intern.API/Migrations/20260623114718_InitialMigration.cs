        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PerformanceName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Value = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Price = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    DailyChange = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    WeeklyChange = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    MonthlyChange = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Performances_Categories_CategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Performances_CategoryId",
                table: "Performances",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_SaleCustomers_SaleId",
                table: "SaleCustomers",
                column: "SaleId",
                unique: true);
